...
namespace Invector.CharacterController
{
    ...
    public class vThirdPersonInput : MonoBehaviour
    {
        ...
        public KeyCode sprintInput = KeyCode.LeftAlt;
        ...
        protected virtual void SprintInput()
        {
            ...
            //    cc.Sprint(false);
            if (Mathf.Abs(cc.input.x) > 0.2 || Mathf.Abs(cc.input.y) > 0.2)
            {
                cc.Sprint(true);
            }
            else { cc.Sprint(false); }
            //Debug.Log(Input.GetAxis(verticallInput) + " " + Input.GetAxis(horizontalInput));
        }
        ...
        protected virtual void CameraInput()
        {
            if (tpCamera == null)
                return;
            var Y = Input.GetAxisRaw(rotateCameraYInput);
            var X = Input.GetAxisRaw(rotateCameraXInput);
        ...
        #endregion
        public void setStopMovement(bool stopMove)
        {
